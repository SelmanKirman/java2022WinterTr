...
public class C02_substring {
    public static void main(String[] args) {
        ...
        String str="1-48 of over 7000 results for \"java\"";
        System.out.println(str);

        int ilkSpace=str.indexOf(" ");// 4
        int ikinciSpace=str.indexOf(" ",ilkSpace+1);
        int ucuncuSpace=str.indexOf(" ",ikinciSpace+1);
        int dorduncuSpace=str.indexOf(" ",ucuncuSpace+1);

        String aramaSonucSayisiStr = str.substring(ucuncuSpace+1,dorduncuSpace);
